...
// Source: github.com/yerlanov/xmexercise/internal/company/service (interfaces: Service)
...
func (m *MockService) Create(arg0 context.Context, arg1 company.Company) (company.Company, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Delete(arg0 context.Context, arg1 int64) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context) ([]company.Company, error) {
	m.ctrl.T.Helper()
